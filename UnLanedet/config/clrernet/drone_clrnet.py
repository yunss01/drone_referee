...
num_points  = 72
max_lanes   = 6          # 한 이미지에 최대 차선 수 (실선+점선 합쳐서)
sample_y    = range(710, 0, -10)

img_norm    = dict(mean=[103.939, 116.779, 123.68], std=[1., 1., 1.])
ori_img_w   = 1280       # 원본 이미지 너비
ori_img_h   = 720        # 원본 이미지 높이
img_w       = 800        # 모델 입력 너비
img_h       = 320        # 모델 입력 높이
cut_height  = 0          # 이미지 상단 잘라내기 (드론 시점이라 0으로 설정)
...
epochs          = 70
batch_size      = 8      # RTX 3060 11GB 기준 (OOM나면 4로 줄이기)
num_train_imgs  = 299    # train 이미지 수
...
# 사전학습 모델 (Tusimple 학습된 것)에서 fine-tuning
